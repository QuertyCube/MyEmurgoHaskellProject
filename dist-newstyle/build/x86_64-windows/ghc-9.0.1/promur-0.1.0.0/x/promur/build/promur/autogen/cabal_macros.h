...
/* package promur-0.1.0.0 */
#ifndef VERSION_promur
#define VERSION_promur "0.1.0.0"
#endif /* VERSION_promur */
#ifndef MIN_VERSION_promur
#define MIN_VERSION_promur(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_promur */
...
#define CURRENT_COMPONENT_ID "promur-0.1.0.0-inplace-promur"
